...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.jsp">Freshies</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          %>
          <li class="nav-item"><a class="nav-link" href="cart.jsp"><span class="icon-shopping_cart">[<%= cartSize %>]</span> </a></li>
          <li class="nav-item"><a class="nav-link" href="admin.jsp"><img src="./images/admin.png"></a></li>
        </ul>
      </div>
    </div>
  </nav>
